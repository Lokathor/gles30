...
//!
//! Generated by [phosphorus](https://docs.rs/phosphorus/0.0.12/phosphorus/).
//!
//! Supported Features:
...
pub mod global_commands {
  ...
  ///
  /// This returns the number of functions it loaded. You can compare it to the
  /// [`NUMBER_OF_GENERATED_GL_COMMANDS`] value, if you want.
